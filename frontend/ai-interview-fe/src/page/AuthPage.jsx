...
export default function AuthPage() {
  ...
  // authStep: "login" | "register" | "forgot" | "checkEmail" | "reset"
              ...
              <div className="bg-white rounded-3xl shadow-xl p-6 bg-white/70 max-w-sm w-full md:w-[455px] md:h-[600px] flex flex-col">
                ...
                <div className="flex-1 space-y-4 overflow-auto">
                  ...
                  <div className="flex gap-4">
                    <button className="flex-1 flex items-center justify-center gap-2 py-3 border-2 border-gray-300 rounded-lg hover:border-gray-400 transition-colors h-0">
                      {/* Google Icon */}
            ...
            {authStep === "forgot" && (
              <div className="bg-white rounded-3xl shadow-xl p-6 bg-white/70 max-w-sm w-full md:w-[455px] md:h-[600px] flex flex-col">
                ...
                <div className="flex-1 flex flex-col justify-center space-y-4 overflow-auto">
                  ...
                  <button
                    onClick={() => setAuthStep("checkEmail")}
                    className="w-full h-10 bg-green-500 hover:bg-green-700 text-white rounded-lg"
                  >
                    Continue
                  </button>
              ...
              <div className="bg-white rounded-3xl shadow-xl p-6 bg-white/70 max-w-sm w-full md:w-[455px] md:h-[600px] flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center space-y-2">
                  <button
                    ...
                    className="w-24 h-24 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center"
                  >
