...
export default function DeviceCheckPage() {
  ...
  const initMedia = async (audioDeviceId, videoDeviceId) => {
    ...
    try {
      ...
      // Silent fail - handled by toast in loadDevices
    }
    return () => {
          ...
          <div className="space-y-5">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5 border-2 border-blue-200 shadow-md">
              ...
              <select
                ...
                className="w-full border-2 border-blue-300 rounded-lg px-4 py-3 focus:border-blue-500 focus:ring-4 focus:ring-blue-200 transition-all duration-200 bg-white shadow-sm font-medium text-gray-700 text-sm"
              >
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-5 border-2 border-purple-200 shadow-md">
              ...
              <select
                ...
                className="w-full border-2 border-purple-300 rounded-lg px-4 py-3 focus:border-purple-500 focus:ring-4 focus:ring-purple-200 transition-all duration-200 bg-white shadow-sm font-medium text-gray-700 text-sm"
              >
